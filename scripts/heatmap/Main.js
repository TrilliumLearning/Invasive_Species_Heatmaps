requirejs(['worldwind.min.js',
        'LayerManager.js',
        'RadiantCircleTile.js'],
    function (WorldWind,
              LayerManager,
              RadiantCircleTile) {
        "use strict";
        ...
        $.ajax({
            ...
            success: function (resp) {
                ...
                for (var i = 0; i < resp.message.length; i++) {
                    ...
                    //     // health[i] = 1;
                    //     health[i] = Math.floor(Math.random() * 10) + 11;
                    // } else if (resp.message[i].cropHealth === "medium") {
                    //     // health[i] = 11;
                    //     health[i] = Math.floor(Math.random() * 10) + 21;
                    // } else if (resp.message[i].cropHealth === "poor") {
                    //     // health[i] = 21;
                    //     health[i] = Math.floor(Math.random() * 10) + 31;
                    // }
                ...
                function drawHeatMap() {
                    ...
                    for (var i = 0; i < intensities.length; i++) {
                        ...
                        if (i === intensities.length - 1) {
                            ...
                            var HeatMapLayer = new WorldWind.HeatMapLayer("HeatMap, Default version", data, {
